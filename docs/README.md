...
6.
    - [ ] 팀 경기 정보에서 총 득점, 총 실점을 합산하는 기능
7.
    - [x] 결과 합계 정보에서 승점을 합산하는 기능
8.
    - [ ] 팀 경기 정보에서 경기 통계, 점수 통계를 생성하는 기능
        - [ ] `예외발생` : 비어 있는 경기 정보 목록
9.
    - [ ] 팀 경기 정보에서 경기 통계, 총 점수를 계산하는 기능
        - [ ] `예외발생` : 비어 있는 경기 정보 목록
10.
    - [ ] 조 별 팀 경기 정보 목록을 사용해 순위 결과를 계산하는 기능
        - 각 경기 정보 목록으로부터 경기 통계를 요청해 승점, 득점차를 확인
            - [ ] `예외발생` : 비어 있는 경기 정보 목록
